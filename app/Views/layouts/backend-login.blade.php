...
<head>
  ...
  <title>Đăng nhập hệ thống quản lí</title>
  ...
  <link rel="stylesheet" href="{{ url('/') }}/public/backend/css/AdminLTE.css">
    <link rel="stylesheet" href="{{ url('/') }}/public/backend/css/custom-datepicker.css">
...
<body>
  <!--
    ...
    -->
    <div class="container">
      <h1 style="font-family: 'Open Sans Condensed', sans-serif; font-size: 46px;" >Trang quản trị THE COFFEE</h1>
