...
@section('box-title','Báo cáo doanh thu hàng ngày')
@section('box-body')
    
    <div class="container-fluid main min-height-100 min-height-100">	
    	
        <div class="report-content">
        	
		    <div class="tab-content">
		    	<h3 class="text-center">Báo cáo bán hàng của ngày: 
		    	    <b>
			    	 	@if(!$date)
			    	 	   <?php  echo date("d/m/Y") ?> 
			    	 	@else 
	    	...
	    	<form action="{{ route('backend.report-search')}}" method="GET" role="form">
				<div class="row d-flex align-items-end">
					<div class="col-md-4">
						<div class="wrapper-datepicker custom-datepicker ">
							<label for="datepicker">Chọn ngày:</label><br/>
							<input type="text" id="datepicker" placeholder="Vui lòng chọn ngày" name="day"autocomplete="off">
						</div>
					</div>
